...
from local.soi.modules.transforms.depthcorrection_transform import DepthCorrectionTransform  # noqa: E402
...
class TestDepthCorrectionTransform(unittest.TestCase):
